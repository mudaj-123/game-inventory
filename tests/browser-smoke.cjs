...
(async () => {
  ...
  await page.waitForFunction(()=>document.querySelector('#report-status').textContent.includes('出库 1'));
  await page.waitForFunction(()=>document.querySelector('#report-results').textContent.includes('00007777'));
